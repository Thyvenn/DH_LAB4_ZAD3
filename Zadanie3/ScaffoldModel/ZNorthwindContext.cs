...
namespace Zadanie3.ScaffoldModel
{
    public partial class ZNorthwindContext : DbContext
    {
        ...
        public virtual DbSet<KlienciSledzenie> KlienciSledzenies { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-UK1AL1K;Initial Catalog=ZNorthwind;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<KlienciSledzenie>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("KlienciSledzenie");

                entity.Property(e => e.SlIdklienta).HasColumnName("slIDklienta");
                ...
                entity.Property(e => e.SledzData)
                    .HasColumnType("datetime")
                    .HasColumnName("sledzData");

                entity.Property(e => e.SledzTyp)
                    .HasMaxLength(6)
                    .IsUnicode(false)
