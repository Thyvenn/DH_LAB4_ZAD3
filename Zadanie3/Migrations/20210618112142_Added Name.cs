...
namespace Zadanie3.Migrations
{
    public partial class AddedName : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "KlienciSledzenie",
                columns: table => new
                {
                    sledzData = table.Column<DateTime>(type: "datetime", nullable: true),
                    sledzTyp = table.Column<string>(type: "varchar(6)", unicode: false, maxLength: 6, nullable: true),
                    slIDklienta = table.Column<int>(type: "int", nullable: true),
                    slNazwa = table.Column<string>(type: "varchar(40)", unicode: false, maxLength: 40, nullable: true)
                },
                constraints: table =>
                {
                });
